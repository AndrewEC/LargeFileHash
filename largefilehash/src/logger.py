...
class Logger():
    ...
    def __init__(self, max_progress, printer=PrintProvider()):
    ...
    def tick_progress(self, to_print):
    ...
    def _create_progress_bar(self, progress):
        number_of_positive_ticks = int(progress * Logger.progress_bar_length)
    ...
    def _pad_message_with_spaces(self, message):
